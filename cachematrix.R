## Inverting matrices is a computational intensive task, these two functions cashes the inverse
## of a matrix and if the matrix is unchanged returns the cached inverted matrix

## This function will take a matrix as argument and returns a list of functions
## accessing the matrix and the inverse of the matrix stored in the local environment
